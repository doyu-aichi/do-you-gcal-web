<script lang="ts">
	const features = [
		{
			title: 'サイドパネル',
			text: '右上の耳タブから開閉。ページを邪魔しないまま、カレンダー、組織図ツリー、名簿、告知メール作成、設定、ガイドを切り替えられます。'
		},
		{
	...
	const steps = [
		...
		'初回はマイページと組織員一覧を開き、組織ツリーと名簿キャッシュを作成します。',
		'マイスケジュールまたは行事活動一覧を開き、当月の同友会スケジュールを検出します。',
	...
	<div class="page hero-inner">
		<div class="hero-copy">
			...
			<p class="lead">
				...
				Google カレンダー、組織図ツリー、名簿キャッシュ、告知メール作成を、同じサイドパネルから扱えるようにします。
			</p>
			<div class="actions">
				<a
