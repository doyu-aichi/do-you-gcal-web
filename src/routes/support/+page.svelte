<script lang="ts">
	const faqs = [
		...
		},
		{
			...
			answer: 'イベント詳細ページには小型ツールバーを追加します。GCal同期、告知メールタブを開く、告知メール本文を直接コピーする操作を、サイドパネルを探さずに実行できます。'
		},
		{
		...
		},
		{
			...
			answer: '組織図の「組織を再取得」と、名簿タブの「名簿キャッシュをクリア」を使ってから、組織員一覧を開き直してください。Google カレンダー状態がずれた場合は、カレンダータブで対象月を再取得します。'
		},
		{
	...
	const changelog = [
		['0.7.x', 'Svelte 5 版サイドパネル、初回セットアップ、状態保持、Google カレンダー複数参照、組織図、名簿タブ、告知メール、出欠返信キャッシュ、申込時同期、案内メール/保管庫リンクを追加'],
