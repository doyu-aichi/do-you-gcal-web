<script lang="ts">
	const faqs = [
		{
			...
			answer: 'あいち同友会サイトのログイン後ページで動作します。予定の抽出と登録は主にマイスケジュール、行事活動、予定詳細、申込登録を対象にしています。'
		},
		{
		...
		},
		{
			...
			answer: '名簿ページや配信先ページを開いたときに検出した会員名簿を localStorage に保存し、氏名、会社、所属バッジ、役職、メールを表示します。ページングと所属バッジによる絞り込みに対応しています。'
		},
		{
	...
	const changelog = [
		['0.7.x', 'Svelte 5 版サイドパネル、Google カレンダー複数参照、組織図ツリー、名簿タブ、出欠返信キャッシュ、申込時同期、案内メール/保管庫リンクを追加'],
	...
	<div class="grid two blocks">
		<section class="panel block">
			...
			<ul>
				...
				<li>組織図ツリーはキャッシュされるため、必要に応じて「組織を再取得」を押します。</li>
				<li>名簿は名簿ページまたは配信先ページを開くと更新されます。</li>
			</ul>
		</section>
