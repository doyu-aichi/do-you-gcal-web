<div class="card">
	<div class="card-content article ">
		<h1 class="title is-size-3 is-size-4-mobile has-text-weight-normal">プライバシーポリシー</h1>
		<div class="content">
			<p>
				カイズ電気株式会社（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
			</p>
			<ul>
				<li>
					<h4><span id="第1条個人情報">第1条（個人情報）</span></h4>
					<p>
						「個人情報」とは，個人情報保護法にいう「個人情報」を指すものとし，生存する個人に関する情報であって，当該情報に含まれる氏名，生年月日，住所，電話番号，連絡先その他の記述等により特定の個人を識別できる情報及び容貌，指紋，声紋にかかるデータ，及び健康保険証の保険者番号などの当該情報単体から特定の個人を識別できる情報（個人識別情報）を指します。
					</p>
				</li>
				<li>
					<h4><span id="第2条個人情報の収集方法">第2条（個人情報の収集方法）</span></h4>
					<p>
				...
				<li>
					<h4>
						<span id="第3条個人情報を収集利用する目的">第3条（個人情報を収集・利用する目的）</span>
					</h4>
			...
			<p>上記の利用目的に付随する目的</p>
			<ul>
				<li><h4><span id="第4条利用目的の変更">第4条（利用目的の変更）</span></h4></li>
			</ul>
			<ul>
				<li>
			...
			<ul>
				<li>
					<h4><span id="第5条個人情報の第三者提供">第5条（個人情報の第三者提供）</span></h4>
					<p>
						...
						/>利用目的に第三者への提供を含むこと<br />第三者に提供されるデータの項目<br
						/>第三者への提供の手段または方法<br
				...
				<li>
					<h4><span id="第6条個人情報の開示">第6条（個人情報の開示）</span></h4>
					<p>
				...
				<li>
					<h4><span id="第8条個人情報の利用停止等">第8条（個人情報の利用停止等）</span></h4>
					<p>
				...
				<li>
					<h4>
						<span id="第9条プライバシーポリシーの変更">第9条（プライバシーポリシーの変更）</span>
					</h4>
					<p>
				...
				<li>
					<h4><span id="第10条お問い合わせ窓口">第10条（お問い合わせ窓口）</span></h4>
					<p>本ポリシーに関するお問い合わせは，下記の窓口までお願いいたします。</p>
				</li>
			</ul>
			<p>
				カイズ電気株式会社<br />担当部署：総務部<br />Eメールアドレス：
				info#052.co.jp（#を@に変更してください）
			</p>
		</div>
	</div>
</div>
